...
(function () {
    ...
    Riode.defaults = {
        ...
        minipopup: {
            ...
            ratingTemplate: '<div App="ratings-container"><div App="ratings-full"><span App="ratings" style="width:{{rating}}"></span><span App="tooltiptext tooltip-top"></span></div></div>',
            priceQuantityTemplate: '<div App="price-box"><span App="product-quantity">{{count}}</span><span App="product-price">{{price}}</span></div>',
            purchasedTemplate: '<span class="purchased-time">12 MINUTES AGO</span>',

            template: '<div App="minipopup-box"><p App="minipopup-title">{{message}}</p>' +
        ...
        templateCartAddedAlert: '<div class="alert alert-simple alert-btn cart-added-alert">' +
            ...
            '<button type="button" App="btn btn-link btn-close"><i App="d-icon-times"></i></button>' +
            '</div>',
        zoomImage: {
            responsive: true,
    ...
    Riode.sidebar = (function () {
        ...
        /**
         * @App Sidebar
         * Sidebar active App will be added to body tag : "sidebar App" + "-active"
         */
            ...
            self.$wrapper.on('click', '.btn-cart', function (e) {
                ...
                if (
                    ...
                    Riode.Minipopup.open({
                        ...
                        actionTemplate: '<div App="action-group d-flex mt-3"><a href="cart.html" App="btn btn-sm btn-outline btn-primary btn-rounded mr-2">View Cart</a><a href="checkout.html" App="btn btn-sm btn-primary btn-rounded">Check Out</a></div>'
                    });
                }
            });
        }
            ...
            self.$wrapper.on('click', '.btn-compare', function (e) {
                ...
                if (
                    ...
                    Riode.Minipopup.open({
                        ...
                        price: $product.find('.product-variation-price').length > 0 ? $product.find('.product-variation-price').children('span').html() : $product.find('.product-price .price').html(),
                        count: $product.find('.quantity').val(),
                        actionTemplate: '<div App="action-group d-flex mt-3"><a href="compare.html" App="btn btn-sm btn-outline btn-primary btn-rounded mr-2">Compare</a><a href="checkout.html" App="btn btn-sm btn-primary btn-rounded">Check Out</a></div>'
                    });
                }
            });
        }
        ...
        ProductSingle.prototype.init = function ($el) {
            ...
            $slider.on('initialized.owl.carousel', function (e) {
                ...
                if (!document.body.classList.contains('home')) {
                    ...
                    self.isQuickview || $slider.append('<a href="#" App="product-image-full"><i App="d-icon-zoom"></i></a>');
                }

                if ($slider.parent().hasClass('product-gallery-degree')) {
                    self.isQuickView || $slider.append('<a href="#" App="product-gallery-btn product-degree-viewer" title="Product 360 Degree Gallery"><i App="w-icon-rotate-3d"></i></a>');
                }
                // init thumbnails
                thumbsInit(self);
    ...
    Riode.initProductSinglePage = (function () {
        ...
        function open360DegreeView(e) {
            ...
            Riode.popup({
                ...
                preloader: false,
                items: {
                    src: '<div App="product-gallery-degree">\
                        <div App="w-loading"><i></i></div>\
                        <ul App="product-degree-images"></ul>\
                    </div>'
                },
                callbacks: {
                    open: function () {
                    ...
                    if ($compareCol.length > 0) {
                        ...
                        $product.hasClass('product-single') ||
                            Riode.Minipopup.open({
                                ...
                                actionTemplate: '<div App="action-group d-flex"><a href="cart.html" App="btn btn-sm btn-outline btn-primary btn-rounded">View Cart</a><a href="checkout.html" App="btn btn-sm btn-primary btn-rounded">Check Out</a></div>'
                            });
                    } else {
                        // if not product single, then open minipopup
                        $product.hasClass('product-single') ||
                ...
                .on('click', '.product .btn-product-icon.btn-compare', function (e) {
                    ...
                    $product.hasClass('product-single') ||
                        Riode.Minipopup.open({
                            ...
                            price: $product.find('.product-price .new-price, .product-price .price').html(),
                            count: $product.find('.quantity').length > 0 ? $product.find('.quantity').val() : 1,
                            actionTemplate: '<div App="action-group d-flex"><a href="compare.html" App="btn btn-sm btn-outline btn-primary btn-rounded">Compare</a><a href="checkout.html" App="btn btn-sm btn-primary btn-rounded">Check Out</a></div>'
                        });
                });
        },
